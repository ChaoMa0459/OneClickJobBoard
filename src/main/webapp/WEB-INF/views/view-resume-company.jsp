 ...
 -->
	...
	private String workLength;
	 -->
					...
					<div class="form-group">
						<label for="workLength" class="col-sm-4 control-label">How
							long is this work? </label>
						<div class="col-sm-8">
							<form:select path="workLength" id="workLength"
								class="form-control">
	 ...
	 -->
					...
					<div class="form-group">
						<div class="col-sm-offset-4 col-sm-8">
							<input type="submit" class="btn btn-success" value="Send Interview" />
						</div>
					</div>

					<div class="form-group">
						<div class="col-sm-offset-4 col-sm-8">
							<a href="viewjob.htm"><input class="btn btn-success"
								value="Back"></a>
						</div>
					</div>
