...
background-size: 50%;">
	<div class="container">
		...
		<div class="view-panel-form"
			style="position: relative; left: 225px; top: 50px; width: 70%;">

			<div class="row">

				<form:form commandName="jobChoice" class="form-horizontal">

					<div class="form-group">
						<label for="jobName" class="col-sm-4 control-label">Please
							Select a Job: </label>
						<div class="col-sm-8" style="width: 40%">
							<form:select path="jobName" id="jobName"
								class="form-control">
								<c:forEach var="job" items="${requestScope.jobs}">
									<form:option value="${job.getJobName()}">${job.getJobName()}</form:option>
								</c:forEach>
							</form:select>
						</div>
					</div>
