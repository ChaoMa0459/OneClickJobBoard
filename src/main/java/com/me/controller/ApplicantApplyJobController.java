...
@RequestMapping("/apply-job-applicant.htm")
@Controller
@SessionAttributes("user")
public class ApplicantApplyJobController {

	@RequestMapping(method = RequestMethod.GET)
	public String formView(ModelMap model, @RequestParam("jobId") long jobId, JobDao jobDao, UserDao userDao, HttpSession session) {
